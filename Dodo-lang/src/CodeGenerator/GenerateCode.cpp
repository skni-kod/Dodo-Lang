...
StringData::StringData(std::string* ptr, bool isMutable) : ptr(ptr), isMutable(isMutable) {}
...
void GenerateCode() {
    ...
    if (Options::targetArchitecture == Options::TargetArchitecture::x86_64) {
        ...
        out << Options::commentPrefix << "Version: " << INCREMENTED_VALUE << "\n";
        out << Options::commentPrefix << "Target architecture: X86_64\n";
        out << Options::commentPrefix << "Architecture version: ";
             if (Options::architectureVersion == Options::AMD64_v1) out << "AMD64_v1\n";
        else if (Options::architectureVersion == Options::AMD64_v2) out << "AMD64_v2\n";
        else if (Options::architectureVersion == Options::AMD64_v3) out << "AMD64_v3\n";
        else if (Options::architectureVersion == Options::AMD64_v4) out << "AMD64_v4\n";
